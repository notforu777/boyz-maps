...
class MapsActivity :  AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    init {
        ...
        repository.add(MarkerEntity(LatLng(59.939191, 30.315777), "Александровская колонна", "Когда колонна была только-только установлена, жители остерегались ходить по площади, потому что думали, что колонна упадёт. Поэтому Монферран (чувак, который её придумал и спроектировал) каждый вечер выходил на площадь погулять со своей собачкой.", R.drawable.colonna, R.drawable.icon_colonna,false))
        ...
        repository.add(MarkerEntity(LatLng(59.952057, 30.308922), "Зоопарк", "Один из са-а-амых ма-а-а-аленьких зоопарков в Европе.", R.drawable.zoopark, R.drawable.icon_zoopark,false))
        repository.add(MarkerEntity(LatLng(59.934027, 30.306340), "Исаакиевский собор", "Это одно из самых высоких зданий центра, так что забраться на колокольню точно стоит, потому что оттуда можно сделать шикарную панораму.", R.drawable.isac_sobor, R.drawable.icon_isak_sobor,false))
        repository.add(MarkerEntity(LatLng(59.944959, 30.335574), "Летний сад","Пруды с лебедями (или это просто утки?), похожие на лабиринт переплетения дорожек и, конечно же, памятник Крылову И. А. (это тот, который много-много басен написал).", R.drawable.letniy,R.drawable.icon_letniy,false ))
        ...
        repository.add(MarkerEntity(LatLng(59.950220, 30.316556), "Петропавловская крепость", "День, в который эта крепость была заложена (27 мая 1703 года), считается днём рождения Питера!", R.drawable.petropavl, R.drawable.icon_petropavl,false))
        repository.add(MarkerEntity(LatLng(59.938787, 30.332187), "Русский музей", "Крупнейшее собрание российского искусства в мире. Высочайшая концентрация русского духа!", R.drawable.russian_musuin, R.drawable.icon_russian_museim,false))
        repository.add(MarkerEntity(LatLng(59.940134, 30.328878), "Храм Спаса на Крови", "Я тебя умоляю, только не путай с московским Собором Василия Блаженного...", R.drawable.chiz, R.drawable.icon_anichkov,false))
        repository.add(MarkerEntity(LatLng(59.945767, 30.372960), "Таврический сад", "Я к Таврическому саду, перепрыгнул через ограду...", R.drawable.tavric, R.drawable.icon_tavric,false))
