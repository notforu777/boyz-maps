...
class MapsActivity :  AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    init {
        ...
        repository.add(MarkerEntity(LatLng(59.932219, 30.324958), "Грифоны", "На реставрации в 99 случаях из 100, так что если тебе удалось их встретить, ты просто лакер.", R.drawable.grifons,R.drawable.icon_grifons))
        ...
        repository.add(MarkerEntity(LatLng(59.940021, 30.338057), "Михайловский замок", "Вы знали, что там летает призрак Павла Первого?",R.drawable.misha_castle,R.drawable.icon_misha_castle))
